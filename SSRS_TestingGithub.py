...
if __name__ == '__main__':
    url = '''http://10.199.4.217/reports/report/FinalBranchReview_HavellsDWH/9.KAM'''
    username = 'hodomain/edw.102'
    password = 'Havells@123'
    output_file = 0
    output_file = get_url(url, username, password, output_file)
